...
console.log("===============================================");
console.log("[Gestión de Recursos Humanos] - FICHA #3407187");
console.log("===============================================");
console.log("");
...
console.log("Categoría:          Tecnologia - Software de RRHH");
...
console.log("Numero empleados:   3500");
console.log("Salario mensual :   4500");
console.log("Horas trabajadas:   40");
...
console.log("Precio:            ", 6000); // TODO: reemplaza 0 con tu cálculo
console.log("Descuento:         ", 6000 * 0.05);
console.log("Precio final:      ", 6000 - 6000 * 0.05); // TODO: reemplaza 0 con tu cálculo
