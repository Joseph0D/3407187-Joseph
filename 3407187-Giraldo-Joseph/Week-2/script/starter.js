...
const DOMAIN_NAME = "Recursos Humanos";
...
const itemName = "Workday HCM"; // reemplaza con algo de tu dominio
...
const itemCategory = 250;
const itemPrice = 100_000;
...
const itemQuantity = true; // reemplaza 0 con el número adecuado
...
console.log("Socios activos:", pendingValue);
